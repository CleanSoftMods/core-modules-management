...
if (!function_exists('modules_management')) {
    /**
     * @return \CleanSoft\Modules\Core\ModulesManagement\Support\ModulesManagement
     */
    function modules_management()
    {
        return \CleanSoft\Modules\Core\ModulesManagement\Facades\ModulesManagementFacade::getFacadeRoot();
    }
}
